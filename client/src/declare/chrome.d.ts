...
declare module chrome.runtime {
    ...
    interface Port {
        name : string;
        disconnect : (a:any) => void;     // FIXME
        onDisconnect : any;             // FIXME
        onMessage : any;                // FIXME
        postMessage : (a:any) => void;    // FIXME
    ...
    export function getBackgroundPage(callback : (w? : Window) => void) : void;
    ...
    export function sendMessage(message : any, responseCallback? : (a:any) => void) : void;
    export function sendMessage(message : any, options? : { includeTlsChannelId? : boolean }, responseCallback? : (a:any) => void) : void;
    export function sendMessage(extensionId : string, message : any, options? : { includeTlsChannelId? : boolean }, responseCallback? : (a:any) => void) : void;

    export function sendNativeMessage(application : string, message : Object, responseCallback : (a:any) => void) : void;
    export function getPlatformInfo(callback : (pi : PlatformInfo) => void) : void;
    export function getPackageDirectoryEntry(callback : (de : DirectoryEntry) => void) : void;
